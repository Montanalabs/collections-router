...
- `collections-router_safe.wave` — the correct design.
- `collections-router_unsafe.wave` — the tempting-but-wrong version (the negative example a model must learn to reject).
