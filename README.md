...
- `collections-router_safe.os` — the correct design.
- `collections-router_unsafe.os` — the tempting-but-wrong version (the negative example a model must learn to reject).
